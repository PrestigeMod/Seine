...
export INITRAMFS_SOURCE=`readlink -f $KERNELDIR/../siyahkernel-SGS2/initramfs3`
export PARENT_DIR=`readlink -f ..`
export USE_SEC_FIPS_MODE=true
export CROSS_COMPILE=/home/crazykamui/toolchain/linaro-12-android-toolchain/bin/arm-eabi-
